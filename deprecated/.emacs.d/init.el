...
;;setting scroll bar in the right side
...
;;config color-theme
(add-to-list 'load-path "~/.emacs.d/themes/monolai-emacs/")
(setq monokai-theme t)

;;(add-to-list 'load-path "~/.emacs.d/themes/monokai/emacs/")
;;(setq monokai-theme t)

;;(add-to-list 'load-path "~/.emacs.d/themes/solarized/")
;;(setq solarized-dark-theme t)
...
;;(global-hl-line-mode t)
;; 设置背景颜色
;; (set-face-background hl-line-face "#87888")
...
;; close all gud window for gdb-many-window
;; M-x kill-all-gud-buffers
(defvar all-gud-modes
    '(gud-mode comint-mode gdb-locals-mode gdb-frames-mode
               gdb-breakpoints-mode)
    "A list of modes when using gdb")
(defun kill-all-gud-buffers ()
    "Kill all gud buffers including Debugger, Locals,
    Frames, Breakpoints.
                                              ...
                                              (setq count
                                                    (1+ count))
                                                                (kill-buffer
                                                                 buffer)
                                                                                  (delete-other-windows)))
        ;; fix the remaining two windows issue
...
(setq diary-mail-addr "civetw9s@gmail.com")
...
;; autoreload  buffer when file changed outside emacs
...
;; customize title bar with login name and file name
...
;;(setq powerline-arrow-shape 'curve)   ;; give your mode-line

;;(setq powerline-color1 "#333333")
...
(setq desktop-base-file-name "qbai-desktop")
(desktop-save-mode t)
...
;;ELPA for emacs23 ,not for emacs24-------------------
...
;;(load "~/.emacs.d/plugins/autopair")
;;(require 'autopair)
;;(autopair-global-mode) ;; to enable in all buffers


;; install ido to search buffer ,files and directory
(require 'ido)
(ido-mode t)
(setq ido-save-directory-list-file nil)
...
;; confugre swbuff
(load "~/.emacs.d/plugins/swbuff/swbuff.el")
(require 'swbuff)
...
;; configure ibuffer to replace buffer menu
 (require 'ibuffer)
 (global-set-key ( kbd "C-x C-b ")' ibuffer)


;; configure smex
(load "~/.emacs.d/plugins/smex/smex.el")
(require 'smex)
(smex-initialize)
...
;; Configure window-numbering
(add-to-list 'load-path
             "~/.emacs.d/plugins/window-numbering")
...
;;            (local-set-key "M-o" 'gtags-toggle-source)
;;            (local-set-key "M-O" 'gtags-find-file-with-completion)))
...
;; default to open cache
(setq projectile-enable-caching t)
;; f5 to open file find
(global-set-key [f5] 'projectile-find-file)


;; condigure ediff
(setq ediff-split-window-function (quote
